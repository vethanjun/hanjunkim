        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 40, alignItems: 'center' }}>
          <div>
            ...
            <h2 style={{ fontSize: 30, fontWeight: 700, letterSpacing: -0.8, margin: '0 0 18px', lineHeight: 1.2 }}>
              A <em style={{ fontFamily: serif, fontStyle: 'italic', color: B.accent }}>multidisciplinary</em> approach
              to biomaterials and biomedical devices for treating human diseases.
            </h2>
            <p style={{ fontSize: 14.5, lineHeight: 1.75, color: ink2, margin: '0 0 14px' }}>
              From the perspective of biomedical and therapeutic engineering researchers, the problems
              arising during the development of biomaterials and biomedical devices are inherently
              multidisciplinary — requiring fundamental knowledge across a wide range of disciplines.
            </p>
            <p style={{ fontSize: 14.5, lineHeight: 1.75, color: ink2, margin: 0 }}>
              Multidisciplinary training <strong>(D.V.M., Ph.D.)</strong> became a strength as a researcher
              working on therapeutic engineering for human health — spanning biocompatibility and safety
              evaluation, therapeutic efficacy evaluation, and bioengineering solutions for chronic human
              diseases.
            </p>
          </div>
          <figure style={{ margin: 0 }}>
            <div style={{
              ...
              <img src={window.__resources.researchSummary} alt="Research summary schematic"
      ...
      <section style={{ padding: '48px 40px', borderBottom: `1px solid ${line}`, background: '#fafaf8' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 24 }}>
          {[
            {
              no: 'I',
              en: 'Pathophysiological Disease Modeling',
              ko: '병태생리학 질환 모델링',
              img: window.__resources.researchDisease,
              caption: 'Disease modeling across four organ systems — Skin · Musculoskeletal · Liver & Nutrition · Tumor',
              desc: 'Animal and organ-on-chip models reproducing human disease biology. We build preclinical systems that capture pathophysiological complexity — from skin wound and dermatitis to osteoarthritis, liver-on-a-chip, and oncology models — bridging bench discovery to clinical translation.',
              keywords: ['Skin-on-a-Chip', 'Liver-on-a-Chip', 'Osteoarthritis', 'Tumor models', '3D cancer modeling'],
              tone: B.accent,
            },
            {
              no: 'II',
              en: 'Biomedical Engineering Platform',
              ko: '생의공학 플랫폼',
              img: window.__resources.researchPlatform,
              caption: 'Four engineering platforms — 3D tissue modeling · Organ-on-a-Chip · Microneedles · Injectable hydrogels',
              desc: 'Engineered biomaterials and device platforms for drug/cell delivery, disease modeling, and minimally invasive therapy. Published across Advanced Healthcare Materials, Small, Advanced Functional Materials, Advanced Science, Biotechnology Journal, and Nanoscale.',
              keywords: ['3D tissue modeling', 'Organ-on-a-Chip', 'Microneedles', 'Injectable hydrogel', 'Drug delivery'],
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 40, alignItems: 'center' }}>
          <figure style={{ margin: 0 }}>
            <div style={{
              ...
              <img src={window.__resources.researchGoal} alt="Translational bioconvergent solutions"
                   style={{ width: '100%', height: 'auto', display: 'block', borderRadius: 4 }}/>
            </div>
            <figcaption style={{ fontFamily: mono, fontSize: 10, color: muted, marginTop: 8, letterSpacing: 0.5 }}>
          ...
          <div>
            ...
            <h2 style={{ fontSize: 28, fontWeight: 700, letterSpacing: -0.8, margin: '0 0 18px', lineHeight: 1.25 }}>
              Fostering <em style={{ fontFamily: serif, fontStyle: 'italic', color: B.accent }}>creative,
              application-based</em> biomedical innovation.
            </h2>
            <p style={{ fontSize: 14.5, lineHeight: 1.75, color: ink2, margin: '0 0 14px' }}>
              The challenges of developing biomaterials and biomedical devices for human disease treatment
              are fundamentally multidisciplinary — demanding insight across biology, medicine, materials
              science, and engineering. Our research aims at treating human diseases through bioengineering
              strategies rooted in this foundation.
            </p>
            <p style={{ fontSize: 14.5, lineHeight: 1.75, color: ink2, margin: 0 }}>
              These experiences align with the educational and research goals of the
              <strong> Department of Pathophysiology, College of Pharmacy at Korea University</strong> —
              fostering creative, application-based biomedical innovation that translates laboratory
              discovery into meaningful clinical impact.
            </p>
          </div>
        </div>
      </section>
...
function PeoplePage() {
  ...
  return (
    <PageShell
      ...
      titleEn="The lab"
      titleKo="연구실 구성원"
      intro={`Currently ${people.length} researchers — one Principal Investigator, graduate students working across biomaterials, drug delivery, tumor therapy, wound healing, and in-vivo modeling.`}
    >
      {/* PI spotlight */}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 40, alignItems: 'start' }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              {['Google Scholar ↗','ORCID ↗','LinkedIn ↗','CV (PDF) ↓'].map(l => (
                <a key={l} style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 14.5, lineHeight: 1.7, color: ink2, maxWidth: 680, margin: '0 0 22px' }}>
              As an expert in pathophysiology, preclinical science, and bioengineering, Dr. Kim uses animal models
              to analyze the therapeutic efficacy and toxicity of biomedical technology on transplanted hosts.
              His research asks <i>how</i> and <i>why</i> new biomedical technologies affect biological systems —
              so that they may become biologically applicable.
            </p>
            ...
            <CVSection label="At a glance">
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                {[
                  ...
                  ['Research area', 'Pathophysiology · Preclinical · Bioengineering'],
  ...
  return (
    <section style={{ padding: '40px', borderTop: `1px solid ${line}`, background: '#fafaf8' }}>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 20 }}>
        <div style={{
          fontFamily: mono, fontSize: 11, letterSpacing: 2, color: muted, fontWeight: 600,
        }}>── ALUMNI</div>
        <h2 style={{ fontSize: 22, fontWeight: 700, letterSpacing: -0.5, margin: 0, color: ink2 }}>
          Past researchers
        </h2>
        ...
        {alumni.map((a, i) => (
          <div key={i} style={{
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              ...
              <div style={{ fontSize: 10.5, color: muted, fontFamily: mono, marginTop: 1 }}>
                {a.period}
              </div>
            </div>
          </div>
    ...
    <div style={{
      ...
      <div style={{ padding: 16, flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ marginTop: 'auto', paddingTop: 10,
          ...
          {m.email && <span style={{ color: ink2 }}>✉ {m.email.split(' at ')[0]}</span>}
        </div>
      </div>
    </div>
  );
...
function NewsPage() {
  ...
  const filtered = filter === 'All' ? newsFull : newsFull.filter(n => n.type === filter);
  ...
  return (
    <PageShell
      ...
      titleKo="소식"
      intro={`${newsFull.length} items from 2020 to present — 한빛사 선정 논문 22건, 석탑강의상·석탑연구상, 학과장 임명, citation milestones, 그리고 연구실 일상까지.`}
    >
      {/* Featured card */}
      <section style={{ padding: '24px 40px 0' }}>
        <div style={{
          ...
          <div style={{ padding: '28px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            {featured.journal && (
              <div style={{ fontFamily: serif, fontSize: 22, fontStyle: 'italic', letterSpacing: -0.3, marginBottom: 4, lineHeight: 1.15 }}>
                {featured.journal}
              </div>
            )}
            {featured.meta && (
              <div style={{ fontFamily: mono, fontSize: 11, color: muted, marginBottom: 12 }}>{featured.meta}</div>
            )}
      ...
      <section style={{ padding: '24px 40px 40px' }}>
        ...
        {view === 'gallery' ? (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 16 }}>
            {filtered.map((n, i) => (
              <a key={i} href={n.link || undefined} target={n.link ? '_blank' : undefined} rel="noopener" style={{
                border: `1px solid ${line}`, borderRadius: 12, overflow: 'hidden',
                background: 'white', cursor: n.link ? 'pointer' : 'default',
                  ...
                  <div>
                    ...
                    {n.journal && (
                      <div style={{ display: 'flex', alignItems: 'baseline', gap: 10, marginBottom: 8, flexWrap: 'wrap' }}>
                        <span style={{ fontFamily: serif, fontStyle: 'italic', fontSize: 15, color: ink }}>{n.journal}</span>
                        {n.meta && <span style={{ fontFamily: mono, fontSize: 11, color: muted }}>{n.meta}</span>}
                      </div>
                    )}
...
function ContactPage() {
  const email = 'hanjun' + '@' + 'korea.ac.kr';
  return (
    <PageShell
      eyebrow="── CONTACT"

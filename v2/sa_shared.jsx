...
const newsFull = [
  { date: '2026.04.11', type: 'event', title: 'Birthday Celebration for Prof. Kim',
    ...
    images: [(window.__resources&&window.__resources['news202604111']||'v2/assets/news-20260411-1.jpg'), (window.__resources&&window.__resources['news202604112']||'v2/assets/news-20260411-2.jpg')] },
  { date: '2026.03.03', type: 'paper', title: '한빛사 논문 선정 (22nd)',
    ...
    image: (window.__resources&&window.__resources['news20260303']||'v2/assets/news-20260303.png') },
  { date: '2026.01.07', type: 'paper', title: '한빛사 논문 선정 (21st)',
    ...
    image: (window.__resources&&window.__resources['news20260107']||'v2/assets/news-20260107.png') },
  { date: '2025.12.19', type: 'event', title: '2025 KU-PPL 실험실 송년회',
    text: '연말을 맞아 실험실 구성원 전체가 함께한 송년회 — 인생네컷 & 저녁식사',
    images: [(window.__resources&&window.__resources['news202512191']||'v2/assets/news-20251219-1.jpg'), (window.__resources&&window.__resources['news202512192']||'v2/assets/news-20251219-2.jpg'), (window.__resources&&window.__resources['news202512193']||'v2/assets/news-20251219-3.jpg')] },
  { date: '2025.12.11', type: 'award', title: '2025-1학기 석탑강의상 수상',
    ...
    image: (window.__resources&&window.__resources['news20251211']||'v2/assets/news-20251211.jpg') },
  { date: '2025.11.01', type: 'promote', title: '첨단융합신약학과 학과장 임명',
    text: '고려대학교 약학대학 첨단융합신약학과 학과장 (2025.11 – 2027.02)',
    image: (window.__resources&&window.__resources['news20251101']||'v2/assets/news-20251101.png') },
  ...
  { date: '2025.10.02', type: 'paper', title: '한빛사 논문 선정 (20th)',
    ...
    image: (window.__resources&&window.__resources['news20251002']||'v2/assets/news-20251002.png') },
  { date: '2025.10.01', type: 'milestone', title: 'Paper Citation > 6K',
    text: 'Google Scholar 총 피인용 수 6,000회 돌파.',
    image: (window.__resources&&window.__resources['news20251001']||'v2/assets/news-20251001.png') },
  { date: '2025.09.26', type: 'paper', title: '한빛사 논문 선정 (19th)',
    ...
    image: (window.__resources&&window.__resources['news20250926']||'v2/assets/news-20250926.png') },
  { date: '2025.09.24', type: 'paper', title: '한빛사 논문 선정 (18th)',
    ...
    image: (window.__resources&&window.__resources['news20250924']||'v2/assets/news-20250924.png') },
  { date: '2025.08.28', type: 'member', title: '곽민진 석박사통합과정생, 2025년 2차 석사과정생연구장려금지원사업 선정',
    image: (window.__resources&&window.__resources['news20250828']||'v2/assets/news-20250828.png') },
  { date: '2025.08.22', type: 'event', title: '2025 고려대학교 약학대학 워크샵',
    text: '참석자: 민석, 진솔, 원준, Prof. Kim, 민영, 수진 — 무창포 비체팰리스 (2025.08.21–08.22)',
    images: [(window.__resources&&window.__resources['news202508221']||'v2/assets/news-20250822-1.jpg'), (window.__resources&&window.__resources['news202508222']||'v2/assets/news-20250822-2.jpg')] },
  { date: '2025.07.04', type: 'award', title: 'Ulziituya, 2025 한국대체시험법학회 우수포스터상 수상',
    ...
    images: [(window.__resources&&window.__resources['news202507041']||'v2/assets/news-20250704-1.jpg'), (window.__resources&&window.__resources['news202507042']||'v2/assets/news-20250704-2.jpg'), (window.__resources&&window.__resources['news202507043']||'v2/assets/news-20250704-3.jpg')] },
  { date: '2025.06.04', type: 'award', title: '2024-2학기 석탑강의상 수상',
    text: '수상 과목: PHAR278(00) 신약개발개론. 상위 5% 강좌에 수여되는 고려대 석탑강의상입니다.',
    image: (window.__resources&&window.__resources['news20250604']||'v2/assets/news-20250604.jpg') },
  { date: '2025.04.28', type: 'paper', title: '한빛사 논문 선정 (17th)',
    ...
    image: (window.__resources&&window.__resources['news20250428']||'v2/assets/news-20250428.png') },
  { date: '2025.04.22', type: 'event', title: 'Lab, 2025 대한약학회 춘계 국제학술대회 참석',
    ...
    images: [(window.__resources&&window.__resources['news202504221']||'v2/assets/news-20250422-1.jpg'),(window.__resources&&window.__resources['news202504222']||'v2/assets/news-20250422-2.jpg'),(window.__resources&&window.__resources['news202504223']||'v2/assets/news-20250422-3.jpg'),(window.__resources&&window.__resources['news202504224']||'v2/assets/news-20250422-4.jpg'),(window.__resources&&window.__resources['news202504225']||'v2/assets/news-20250422-5.jpg')] },
  { date: '2025.04.11', type: 'award', title: '김민석, 2025 대한약학회 춘계 국제학술대회 트래블어워드 수상',
    image: (window.__resources&&window.__resources['news20250411']||'v2/assets/news-20250411.png') },
  { date: '2025.04.09', type: 'event', title: 'Birthday Celebration for Prof. Kim',
    ...
    images: [(window.__resources&&window.__resources['news202504091']||'v2/assets/news-20250409-1.jpg'), (window.__resources&&window.__resources['news202504092']||'v2/assets/news-20250409-2.jpg'), (window.__resources&&window.__resources['news202504093']||'v2/assets/news-20250409-3.jpg')] },
  ...
  { date: '2025.03.13', type: 'event', title: 'KU-PPL Lab Lunch',
    image: (window.__resources&&window.__resources['news20250313']||'v2/assets/news-20250313.jpg') },
  { date: '2025.02.27', type: 'milestone', title: 'Paper Citation > 5K',
    text: 'Google Scholar 총 피인용 수 5,000회 돌파.',
    image: (window.__resources&&window.__resources['news20250227']||'v2/assets/news-20250227.png') },
  { date: '2025.02.20', type: 'award', title: '2024 석탑연구상 수상 (학술논문 부문)',
    ...
    image: (window.__resources&&window.__resources['news20250220']||'v2/assets/news-20250220.jpg') },
  { date: '2024.12.23', type: 'event', title: '2024 KU-PPL Christmas Dinner',
    image: (window.__resources&&window.__resources['news20241223']||'v2/assets/news-20241223.jpg') },
  { date: '2024.12.06', type: 'award', title: '지유림, 2024 약과학자 경연대회 대상 수상',
    text: '고려대학교 약학대학 약과학자 경연대회에서 대상 수상.',
    image: (window.__resources&&window.__resources['news20241206']||'v2/assets/news-20241206.jpg') },
  { date: '2024.11.21', type: 'award', title: '한국생체재료학회 나이벡 미래과학자상 수상 & 추계 학술대회 참석',
    ...
    image: (window.__resources&&window.__resources['news20241121']||'v2/assets/news-20241121.jpg'),
    images: [(window.__resources&&window.__resources['news20241121']||'v2/assets/news-20241121.jpg'), (window.__resources&&window.__resources['news20241121Extra']||'v2/assets/news-20241121-extra.jpg')] },
  { date: '2024.10.04', type: 'paper', title: '한빛사 논문 선정 (16th)',
    ...
    image: (window.__resources&&window.__resources['news20241004']||'v2/assets/news-20241004.png') },
  { date: '2024.09.02', type: 'member', title: '장원준 석사과정생, 2024년 2차 석사과정생연구장려금지원사업 최종 선정',
    image: (window.__resources&&window.__resources['news20240902']||'v2/assets/news-20240902.png') },
  { date: '2024.07.01', type: 'milestone', title: 'Paper Citation > 4K',
    text: 'Google Scholar 총 피인용 수 4,000회 돌파.',
    image: (window.__resources&&window.__resources['news20240701']||'v2/assets/news-20240701.png') },
  { date: '2024.06.05', type: 'award', title: '2023-2학기 석탑강의상 · 우수강좌상 수상',
    text: '석탑강의상: PHAR278(00) 신약개발개론 · 우수강좌상: PHAR316(00) 병태생리학.',
    image: (window.__resources&&window.__resources['news20240605']||'v2/assets/news-20240605.jpg') },
  { date: '2024.04.19', type: 'event', title: 'KU-PPL, 2024 대한약학회 춘계 학술대회 참석',
    text: '2024.04.17 – 2024.04.19 대한약학회 춘계 학술대회 참석',
    image: (window.__resources&&window.__resources['news20240419']||'v2/assets/news-20240419.jpg') },
  { date: '2024.04.11', type: 'event', title: 'Birthday Celebration for Prof. Kim',
    text: 'Thanks to the Lab members — Tuya, 민석, 원준, 수진 !!',
    image: (window.__resources&&window.__resources['news20240411']||'v2/assets/news-20240411.jpg') },
  { date: '2024.03.29', type: 'press', title: 'KU SEJONG Magazine (2023, Vol 48) 인터뷰 게재',
    ...
    image: (window.__resources&&window.__resources['news20240329']||'v2/assets/news-20240329.png') },
  { date: '2024.02.22', type: 'award', title: '2023 석탑연구상 수상 (학술논문 부문)',
    ...
    image: (window.__resources&&window.__resources['news20240222']||'v2/assets/news-20240222.png') },
  { date: '2023.12.06', type: 'paper', title: '한빛사 논문 선정 (15th)',
    ...
    image: (window.__resources&&window.__resources['news20231206']||'v2/assets/news-20231206.png') },
  { date: '2023.12.06', type: 'paper', title: '한빛사 논문 선정 (14th)',
    ...
    image: (window.__resources&&window.__resources['news2023120614th']||'v2/assets/news-20231206-14th.png') },
  { date: '2023.11.28', type: 'award', title: '2023-1학기 석탑강의상 수상',
    text: '수상 과목: PHAR549(00) 동물용의약품학.',
    image: (window.__resources&&window.__resources['news20231128']||'v2/assets/news-20231128.png') },
  { date: '2023.11.20', type: 'paper', title: '한빛사 논문 선정 (13th)',
    ...
    image: (window.__resources&&window.__resources['news20231120']||'v2/assets/news-20231120.png') },
  { date: '2023.10.03', type: 'milestone', title: 'Paper Citation > 3K',
    text: 'Google Scholar 총 피인용 수 3,000회 돌파.',
    image: (window.__resources&&window.__resources['news20231003']||'v2/assets/news-20231003.png') },
  { date: '2023.06.30', type: 'paper', title: '한빛사 논문 선정 (12th)',
    ...
    image: (window.__resources&&window.__resources['news20230630']||'v2/assets/news-20230630.png') },
  { date: '2023.06.29', type: 'paper', title: '한빛사 상위피인용논문 선정 (11th)',
    ...
    image: (window.__resources&&window.__resources['news20230629']||'v2/assets/news-20230629.png') },
  { date: '2023.06.28', type: 'paper', title: '한빛사 논문 선정 (10th)',
    ...
    image: (window.__resources&&window.__resources['news20230628']||'v2/assets/news-20230628.png') },
  { date: '2023.06.19', type: 'paper', title: '한빛사 논문 선정 (9th)',
    ...
    image: (window.__resources&&window.__resources['news20230619']||'v2/assets/news-20230619.png') },
  { date: '2023.05.30', type: 'award', title: '한국연구재단 개인기초연구 — 생애기본연구/기본연구 과제 선정',
    image: (window.__resources&&window.__resources['news20230530']||'v2/assets/news-20230530.png') },
  { date: '2023.03.03', type: 'paper', title: '한빛사 논문 선정 (8th)',
    ...
    image: (window.__resources&&window.__resources['news20230303']||'v2/assets/news-20230303.png') },
  { date: '2023.02.14', type: 'event', title: 'College of Pharmacy — 2023 Winter Workshop',
    image: (window.__resources&&window.__resources['news20230214']||'v2/assets/news-20230214.jpg') },
  { date: '2023.01.02', type: 'paper', title: '한빛사 논문 선정 (7th)',
    ...
    image: (window.__resources&&window.__resources['news20230102']||'v2/assets/news-20230102.png') },
  { date: '2022.12.21', type: 'event', title: 'Farewell Dinner @ Terasaki Institute',
    image: (window.__resources&&window.__resources['news20221221']||'v2/assets/news-20221221.png') },
  { date: '2022.11.30', type: 'event', title: 'Terasaki Institute — New Building Set-up Faculty Meeting',
    ...
    image: (window.__resources&&window.__resources['news20221130']||'v2/assets/news-20221130.png') },
  { date: '2022.11.29', type: 'milestone', title: 'Paper Citation > 2K',
    text: 'Google Scholar 총 피인용 수 2,000회 돌파.',
    image: (window.__resources&&window.__resources['news20221129']||'v2/assets/news-20221129.png') },
  { date: '2022.08.27', type: 'event', title: '2022 Terasaki Intern Training',
    image: (window.__resources&&window.__resources['news20220827']||'v2/assets/news-20220827.png') },
  { date: '2022.08.10', type: 'paper', title: '한빛사 논문 선정 (6th)',
    ...
    image: (window.__resources&&window.__resources['news20220810']||'v2/assets/news-20220810.png') },
  { date: '2022.05.09', type: 'paper', title: '한빛사 논문 선정 (5th)',
    ...
    image: (window.__resources&&window.__resources['news20220509']||'v2/assets/news-20220509.png') },
  { date: '2022.04.21', type: 'paper', title: '한빛사 논문 선정 (4th)',
    ...
    image: (window.__resources&&window.__resources['news20220421']||'v2/assets/news-20220421.png') },
  { date: '2022.03.09', type: 'paper', title: '한빛사 논문 선정 (3rd)',
    ...
    image: (window.__resources&&window.__resources['news20220309']||'v2/assets/news-20220309.png') },
  { date: '2021.10.12', type: 'milestone', title: 'Paper Citation > 1K',
    text: 'Google Scholar 총 피인용 수 1,000회 돌파.',
    image: (window.__resources&&window.__resources['news20211012']||'v2/assets/news-20211012.png') },
  { date: '2021.06.29', type: 'event', title: 'Terasaki Institute On-site Open',
    image: (window.__resources&&window.__resources['news20210629']||'v2/assets/news-20210629.png') },
  { date: '2021.03.17', type: 'paper', title: '한빛사 논문 선정 (2nd)',
    ...
    image: (window.__resources&&window.__resources['news20210317']||'v2/assets/news-20210317.png') },
  { date: '2021.03.08', type: 'paper', title: '한빛사 논문 선정 (1st)',
    ...
    image: (window.__resources&&window.__resources['news20210308']||'v2/assets/news-20210308.png') },
  { date: '2020.08.31', type: 'award', title: 'Second Miler Award',
    image: (window.__resources&&window.__resources['news20200831']||'v2/assets/news-20200831.png') },
  { date: '2020.07.04', type: 'event', title: 'Staying at Home Campaign at TIBI',
    image: (window.__resources&&window.__resources['news20200704']||'v2/assets/news-20200704.png') },
  { date: '2020.05.23', type: 'promote', title: 'Appointed as an Assistant Professor at Terasaki Institute for Biomedical Innovation (TIBI)',
    image: (window.__resources&&window.__resources['news20200523']||'v2/assets/news-20200523.png') },
  { date: '2020.05.01', type: 'event', title: 'Khademhosseini Lab at UCLA',
    ...
    image: (window.__resources&&window.__resources['news201808']||'v2/assets/news-201808.png') },
];
...
const people = [
  { name: 'Hanjun Kim, Ph.D.', role: 'Principal Investigator', ko: '책임교수', tags: ['Associate Professor','Pathophysiology'], pi: true, since: '2023', photo: (window.__resources&&window.__resources['peopleHanjunkim']||'v2/assets/people-hanjunkim.jpg') },
  ...
  { name: 'Ulziituya Batjargal', ko: '박사과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleBatjargal']||'v2/assets/people-batjargal.jpg'),
  ...
  { name: 'Jinsol Choi', ko: '박사과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleJinsol']||'v2/assets/people-jinsol.png'),
  ...
  { name: 'Minseok Kim', ko: '석박통합과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleMinseok']||'v2/assets/people-minseok.jpg'),
    tags: ['Lung','Asthma'] },
  ...
  { name: 'Soojin Park', ko: '석박통합과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleSoojin']||'v2/assets/people-soojin.jpg'),
  ...
  { name: 'Wonjun Jang', ko: '석박통합과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleWonjun']||'v2/assets/people-wonjun.jpg'),
  ...
  { name: 'Minjin Kwak', ko: '석사과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleMinjin']||'v2/assets/people-minjin.jpg'),
    tags: ['Lung'] },
  ...
  { name: 'Min Young Lee', ko: '석사과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleMinyoung']||'v2/assets/people-minyoung.jpg'),
    tags: ['Cancer'] },
  ...
  { name: 'Minjeong Kim', ko: '석박통합과정', group: 'grad',
    ...
    photo: (window.__resources&&window.__resources['peopleMinjeong']||'v2/assets/people-minjeong.jpg'),
    tags: ['Lung'] },
  ...
  { name: 'Yurim Ji', ko: '학부연구생', group: 'ug',
    ...
    photo: (window.__resources&&window.__resources['alumniYurim']||'v2/assets/alumni-yurim.png'),
    tags: [] },
  { name: 'Jin Kim', ko: '학부연구생', group: 'ug',
    role: 'Undergraduate Researcher', since: '2026.01',
    affil: 'College of Pharmacy, Korea University',
    email: 'jinkim0607 at korea.ac.kr',
    photo: (window.__resources&&window.__resources['peopleJinkim']||'v2/assets/people-jinkim.jpg'),
    tags: [] },
];
...
const alumni = [
  ...
  { name: 'Seung-Yun Lee',     role: 'Undergraduate Intern', period: '2026.01 – 2026.02', photo: (window.__resources&&window.__resources['alumniSeungyun']||'v2/assets/alumni-seungyun.jpg'), affil: 'Konkuk University' },
  { name: 'Eun-woo Kim',       role: 'Undergraduate Intern', period: '2026.01 – 2026.02', photo: (window.__resources&&window.__resources['alumniEunwoo']||'v2/assets/alumni-eunwoo.png'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Sumin Kwon',        role: 'Undergraduate Intern', period: '2025.12 – 2026.02', photo: (window.__resources&&window.__resources['alumniSumin']||'v2/assets/alumni-sumin.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Seoyean Cho',       role: 'Undergraduate Intern', period: '2025.09 – 2025.12', photo: (window.__resources&&window.__resources['alumniSeoyean']||'v2/assets/alumni-seoyean.png'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Linna Teng',        role: 'Undergraduate Intern', period: '2025.03 – 2025.12', photo: (window.__resources&&window.__resources['alumniLinna']||'v2/assets/alumni-linna.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Lauren Hayoung Lee',role: 'Undergraduate Intern', period: '2025.01 – 2025.12', photo: (window.__resources&&window.__resources['alumniLauren']||'v2/assets/alumni-lauren.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Seung Hu Noh',      role: 'Undergraduate Intern', period: '2025.01 – 2025.12', photo: (window.__resources&&window.__resources['alumniSeunghu']||'v2/assets/alumni-seunghu.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Yurim Ji',          role: 'Undergraduate Intern', period: '2024.01 – 2025.08', photo: (window.__resources&&window.__resources['alumniYurim']||'v2/assets/alumni-yurim.png'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Hyun Young Kim',    role: 'Undergraduate Intern', period: '2025.01 – 2025.02', photo: (window.__resources&&window.__resources['alumniHyunyoung']||'v2/assets/alumni-hyunyoung.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Sa Kang Hong',      role: 'Undergraduate Intern', period: '2025.01 – 2025.02', photo: (window.__resources&&window.__resources['alumniSakang']||'v2/assets/alumni-sakang.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Jiwon Lee',         role: 'Undergraduate Intern', period: '2024.08 – 2024.12', photo: (window.__resources&&window.__resources['alumniJiwon']||'v2/assets/alumni-jiwon.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Seo Hyun Jang',     role: 'Undergraduate Intern', period: '2024.08', photo: (window.__resources&&window.__resources['alumniSeohyun']||'v2/assets/alumni-seohyun.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Jia Choi',          role: 'Undergraduate Intern', period: '2024.08', photo: (window.__resources&&window.__resources['alumniJiachoi']||'v2/assets/alumni-jiachoi.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Hyorin Nam',        role: 'Undergraduate Intern', period: '2024.03 – 2024.08', photo: (window.__resources&&window.__resources['alumniHyorin']||'v2/assets/alumni-hyorin.png'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Yunjin Choi',       role: 'Undergraduate Intern', period: '2024.03 – 2024.07', photo: (window.__resources&&window.__resources['alumniYunjin']||'v2/assets/alumni-yunjin.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Yeonggyeong Yeon',  role: 'Undergraduate Intern', period: '2023.07 – 2024.06', photo: (window.__resources&&window.__resources['alumniYeonggyeong']||'v2/assets/alumni-yeonggyeong.jpg'), affil: 'College of Pharmacy, Korea University' },
  { name: 'Sungsoo Han',       role: 'Undergraduate Intern', period: '2023.07 – 2023.12', photo: (window.__resources&&window.__resources['alumniSungsoo']||'v2/assets/alumni-sungsoo.jpg'), affil: 'College of Pharmacy, Korea University' },
];

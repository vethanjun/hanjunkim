          ...
          {[
            {
              ...
              ko: '전임상 약효 평가 · 질환 모델링',
              img: (window.__resources&&window.__resources['researchDisease']||'v2/assets/research-disease.png'),
            ...
            },
            {
              ...
              ko: '동물실험 대체 전임상 플랫폼',
              img: (window.__resources&&window.__resources['researchAltPlatform']||'v2/assets/research-alt-platform.jpg'),
            ...
            },
            {
              ...
              ko: '중개 치료제 개발',
              img: (window.__resources&&window.__resources['researchPlatform']||'v2/assets/research-platform.png'),
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 40, alignItems: 'start' }}>
          <div>
            <div style={{
              ...
              <img
                src={pi.photo || (window.__resources&&window.__resources['peopleHanjunkim']||'v2/assets/people-hanjunkim.jpg')}
